    ...
    <div
      ...
      className={cn(
        "data-[active=true]:border-ring data-[active=true]:ring-ring/50 " +
          ...
          "dark:bg-input/30 border-input relative flex h-9 w-9 items-center justify-center border-y border-r " +
          "text-sm bg-input-background transition-all outline-none first:rounded-l-md first:border-l last:rounded-r-md " +
